...
#include "creature.h"
#include "tile.h"
#include "ui_toolbar.h" // Für RME::UI::UIToolbar
...
protected:
  ...
  static int countMaxFills; // Declare static member

  Editor &editor;
  std::unique_ptr<MapDrawer> drawer; // Change to unique_ptr
  int keyCode;
...
public:
  ...
  void StartHouseCreationFlow(uint32_t target_town_id = 0);
  void AdvanceHouseCreationFlow();
...
public:
  MapPopupMenu(MapEditor &map_editor_ref);
