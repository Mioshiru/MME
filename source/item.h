...
public:
	...
	*/
	...
	void setCustomAttribute(const std::string& key, int value) {
		custom_attributes[key] = value;
	}

	int getCustomAttribute(const std::string& key, int default_val = 0) const {
...
protected:
	std::map<std::string, int> custom_attributes;
