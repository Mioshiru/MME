...
#define __W_RME_APPLICATION_NAME__ wxString("Mio's Map Editor - Community Edition")
#define __RME_APPLICATION_NAME__ std::string("Mio's Map Editor - Community Edition")
...
#else
	#define __RME_VERSION__ std::string("1.9.0 (by Mioshiro)")
	#define __W_RME_VERSION__ wxString("1.9.0 (by Mioshiro)")
#endif
// OS
...
#define MAP_MAX_WIDTH 65535
#define MAP_MAX_HEIGHT 65535
...
// Lights
constexpr int MaxLightIntensity = 15;
...
// Live Packet Types
#define PACKET_PING 0x1E
#define PACKET_PONG 0x1F
